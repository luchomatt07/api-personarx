...
* The original package name 'com.example.api-personarx' is invalid and this project uses 'com.example.apipersonarx' instead.
...
* [Spring Data Reactive MongoDB](https://docs.spring.io/spring-boot/docs/2.7.17/reference/htmlsingle/index.html#data.nosql.mongodb)
